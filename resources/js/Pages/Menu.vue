...
const popularGames = computed(() =>
    [...games.value].sort((a, b) => b.players - a.players).slice(0, 3)
);

// Helpers
const getDifficultyColor = (diff) =>
    ({ easy: "success", medium: "warning", hard: "danger" }[diff] ||
    "secondary");
const clearFilters = () => {
    searchQuery.value = "";
    selectedDifficulty.value = "all";
...
<template>
    ...
    <section class="padding-navbar text-center container">
        <h1
            class="display-3 fw-bold mb-3 fade-in"
            :class="{ 'slide-in-left': isVisible }"
        >
            {{ t("choose_game") }}
        </h1>
        <p
            class="lead text-light opacity-75 fade-in delay-200"
            :class="{ 'slide-in-right': isVisible }"
        >
            {{ t("choose_game_subtitle") }}
        </p>

        <div
            class="d-flex justify-content-center flex-wrap mt-4 fade-in delay-300"
            :class="{ 'slide-in-left': isVisible }"
        >
                ...
                >
                    <div class="card card-game featured h-100">
                        ...
                        <div class="card-body">
                            ...
                            <p
                                class="card-text text-light text-truncate opacity-75"
                            >
                                {{ game.description }}
                            </p>
                            <div class="game-meta mb-3">
                                <span
                                    :class="`badge bg-${getDifficultyColor(
                                        game.difficulty
                                    )} me-2`"
                            ...
                            >
                                <small class="text-secondary"
                                    ...
                                    ></font-awesome-icon>
                                    {{ game.players.toLocaleString() }}</small
                                >
                                <Link
                ...
                <div class="row g-3">
                    <div class="col-md-4">
                        <div class="position-relative">
                            <input
                                v-model="searchQuery"
                                type="text"
                                class="form-control ps-5 bg-glass text-light"
                    ...
                    <div class="col-md-3">
                        <select
                            ...
                            class="form-select bg-glass text-light"
                        >
                            <option
    ...
    <section class="games-grid py-5">
        <div class="container">
            ...
            <div v-else class="text-center py-5 text-light">
                ...
                <button @click="clearFilters" class="btn btn-accent">
                    <font-awesome-icon
                        icon="fas fa-refresh"
                        class="me-1"
                    ></font-awesome-icon>
