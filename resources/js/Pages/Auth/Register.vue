    ...
    <div class="container d-flex justify-content-center align-items-center min-vh-100 py-5 mt-5">
        <div class="glass-panel p-4 p-md-5 w-100 mx-auto" style="max-width: 450px;">
            <div class="text-center mb-4">
                ...
                <p class="text-light opacity-75 mb-0">Preencha os campos abaixo</p>
            </div>
            ...
            <form @submit.prevent="form.post(route('register_store'))">
                ...
                <div class="mb-3">
                    ...
                    <input type="text" id="name" v-model="form.name" class="form-control" :class="{'is-invalid': form.errors.name}" required autofocus />
                ...
                <div class="mb-3">
                    ...
                    <input type="email" id="email" v-model="form.email" class="form-control text-lowercase" :class="{'is-invalid': form.errors.email}" required />
                ...
                <div class="mb-3">
                    ...
                    <input type="password" id="password" v-model="form.password" class="form-control" :class="{'is-invalid': form.errors.password}" required />
                ...
                <div class="mb-4 form-check">
                    <input type="checkbox" class="form-check-input" id="terms" v-model="form.terms" :class="{'is-invalid': form.errors.terms}" required />
                ...
                <div class="d-grid mb-2">
                    <button type="submit" class="btn game-btn py-3 rounded-3" :disabled="form.processing">Criar Conta</button>
                </div>
            </form>

            <div class="text-center mt-3">
                <span class="text-muted small">Já possui uma conta?</span>
                <Link :href="route('login')" class="text-decoration-none fw-semibold ms-1 small">Faça login</Link>
            </div>
        </div>
    </div>
</template>
